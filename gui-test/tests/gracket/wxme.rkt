...
(let ()
  ...
  (define (kmp-search txt str all?)
    (send txt do-find-string-all str 'forward 0 (send txt last-position) (not all?) #t #t (λ (x) #f)))
  ...
  (expect (send (txt " x\n ") do-find-string-all "X" 'forward 0 'eof #f #t #f (λ (x) #f))
          '(1))
  (expect (send (txt "xXxXxX") do-find-string-all "x" 'forward 0 'eof #f #t #f (λ (x) #f))
          '(0 1 2 3 4 5))
  (expect (send (txt "xXxXxX") do-find-string-all "x" 'forward 2 4 #f #t #f (λ (x) #f))
          '(2 3))
  (expect (send (txt "xyxyxyxyxyx") do-find-string-all "xy" 'forward 2 5 #f #t #t (λ (x) #f))
          '(2))
  (expect (send (txt "abcdabcdabcd") do-find-string-all "abcd" 'forward 0 'eof #f #f #t (λ (x) #f))
          '(4 8 12))
  (expect (send (txt "qqabcdabcdabcd") do-find-string-all "abcd" 'forward 0 'eof #t #f #t (λ (x) #f))
          6)
  (expect (send (txt "qqabcdabcdabcd") do-find-string-all "abcd" 'forward 0 'eof #t #t #t (λ (x) #f))
          2)
  (expect (send (txt "abcdabcdabcd") do-find-string-all "abcd" 'backward 12 0 #f #t #t (λ (x) #f))
          '(12 8 4))
  (expect (send (txt "abcdabcdabcd") do-find-string-all "abcd" 'backward 12 0 #f #f #t (λ (x) #f))
          '(8 4 0))
  (expect (send (txt "abcd\nabcdabcd") do-find-string-all "abcd" 'backward 12 0 #f #t #t (λ (x) #f))
          '(9 4))
  (expect (send (txt "abcd\nabcdabcd") do-find-string-all "abcd" 'backward 13 0 #f #t #t (λ (x) #f))
          '(13 9 4))
  (expect (send (txt "abcdabcd\nabcd") do-find-string-all "abcd" 'backward 12 0 #f #t #t (λ (x) #f))
          '(8 4))
  (expect (send (txt "abcdabcd\nabcd") do-find-string-all "abcd" 'backward 13 0 #f #t #t (λ (x) #f))
          '(13 8 4))
  (expect (send (txt "abcdabcd\nabcd") do-find-string-all "abcd" 'backward 8 0 #f #t #t (λ (x) #f))
          '(8 4))
  (expect (send (txt "abcdabcd\nabcd") do-find-string-all "abcd" 'forward 4 13 #f #t #t (λ (x) #f))
          '(4 9))
  (expect (send (txt "xyz") do-find-string-all "xyz" 'backward 3 0 #t #f #t (λ (x) #f))
          0)
  (expect (send (txt "xyz") do-find-string-all "xyz" 'backward 3 0 #t #t #t (λ (x) #f))
          3)
  ...
  (let ([t (new text%)])
    ...
    (send t insert "abc")
    (send t insert "abc")
    (expect (send t do-find-string-all "abc" 'forward 0 (send t last-position) #f #t #t (λ (x) #t))
            '(0 3 6))
    (expect (send t do-find-string-all "abc" 'backward (send t last-position) 0 #f #t #t (λ (x) #t))
            '(9 6 3))
    (expect (send t do-find-string-all "ca" 'forward 0 (send t last-position) #f #t #t (λ (x) #t))
            '(2 5))
    (expect (send t do-find-string-all "ca" 'backward (send t last-position) 0 #f #t #t (λ (x) #t))
            '(7 4)))
  ...
  (let ([t1 (new text%)]
    ...
    (send t1 insert "abc")
    (send t2 insert "abc")
    (expect (send t1 do-find-string-all "abc" 'forward 0 (send t1 last-position) #f #t #t (λ (x) #t))
            (list 0 (list t2 0) 4))
    (expect (send t1 do-find-string-all "abc" 'backward (send t1 last-position) 0 #f #t #t (λ (x) #t))
            (list 7 (list t2 3) 3))
    (expect (send t1 do-find-string-all "abca" 'forward 0 (send t1 last-position) #f #t #t (λ (x) #t))
            '())
    (expect (send t1 do-find-string-all "cabc" 'forward 0 (send t1 last-position) #f #t #t (λ (x) #t))
            '()))
  ...
  (let ([t1 (new text%)]
    ...
    (send t1 insert (new editor-snip% [editor t2]))
    (send t2 insert "abc")
    (expect (send t1 do-find-string-all "abc" 'forward 0 (send t1 last-position) #f #t #t
                  (λ (x)
                    (not (object=? (send x get-editor) t2))))
            (list 0))
    (expect (send t1 do-find-string-all "abc" 'backward (send t1 last-position) 0 #f #t #t
                  (λ (x)
                    (not (object=? (send x get-editor) t2))))
            (list 3)))
  ...
  (let ([t1 (new text%)]
    ...
    (send t1 insert "abcd")
    (send t2 insert "abc")
    (expect (send t1 do-find-string-all "abcd" 'forward 0 (send t1 last-position) #t #t #t (λ (x) #t))
            4))
  ...
  (let ([t1 (new text%)]
    ...
    (send t2 insert "abcd")
    (send t3 insert "abcd")
    (expect (send t1 do-find-string-all "abcd" 'forward 0 (send t1 last-position) #f #t #t (λ (x) #t))
  ...
  (let ([t1 (new text%)]
    ...
    (send t2 insert "abcd")
    (send t3 insert "abcd")
    (expect (send t1 do-find-string-all "abcd" 'forward 0 (send t1 last-position) #f #t #t
                  (λ (x)
                    (and (not (object=? (send x get-editor) t2))
                         (not (object=? (send x get-editor) t3)))))
            (list)))
